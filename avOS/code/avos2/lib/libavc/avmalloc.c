...
//**** (GCL 3/19/04) ************************************************************************
/*
    Changed practically nothing in actual code, it's all the original code from BGET.
    Changed filenames to avmalloc.c and avmalloc.h to avoid confusion and make sense.
    Deleted the whole section of original code that was a built-in testing program.
    Changed define#'s and header file to leave out everything except the core functions:
    bpool, bget, bgetz, bgetr, & brel.
    (for now, the rest may work, but these are all we need to get started at this point)

    See avmalloc.h in avos module /include directory for general usage information
    And mallocTest.c in avos module /src/examples dir for actual implementation example
*/
//*******************************************************************************************
...
//*******************************************************************************************
//**** (GCL 3/19/04) ************************************************************************
//**********  Below defines changed so we don't compile stuff we don't need now  ************
//*******************************************************************************************
...
//**** (GCL 3/19/04) ************************************************************************
//****************  Below removed and put into avmalloc.h for clarity  **********************
//#include <stdio.h>
//*******************************************************************************************


//**** (GCL 3/19/04) ************************************************************************
//**********  Below added to ensure that we compile fastest smallest version  ***************
#ifndef NDEBUG
#define NDEBUG
#endif
//*******************************************************************************************
...
//**** (GCL 3/19/04) ************************************************************************
//*****************  Below changed to load the differently named h file  ********************
//#include "bget.h"
#include <avmalloc.h>
//*******************************************************************************************
