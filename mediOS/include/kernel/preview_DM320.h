...
#ifndef __PREVIEW_DM320_H
#define __PREVIEW_DM320_H
...
#define PREVIEW_LUMA_RANGE             (PREVIEW_BASE + 0x0056)
#define PREVIEW_CHROMA_RANGE           (PREVIEW_BASE + 0x0058)
...
#define PREVIEW_STP_VD_INTERNAL        0x1000
#define PREVIEW_STP_VD_EXTERNAL        0x0000

#define PREVIEW_YCR_MIN_SHIFT          0
#define PREVIEW_YCR_MAX_SHIFT          8

#define PREVIEW_RESIZE_RATIO           64
