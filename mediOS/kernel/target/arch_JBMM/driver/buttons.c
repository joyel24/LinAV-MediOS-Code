...
int arch_btn_readHardware(void){
    ...
    /*printk("Button port: 0=%x,1=%x,2=%x ON=%d OFF=%d\n",inw(BUTTON_PORT0)&0xF,inw(BUTTON_PORT1)&0xF,inw(BUTTON_PORT1)&0xF,
            (!GIO_IS_SET(GIO_ON_BTN))?1:0,(!GIO_IS_SET(GIO_OFF_BTN))?1:0);*/
