...
const int intervals[11] = {24, 19, 15, 12, 10, 8, 6, 5, 4, 3, 2};
...
//=======================================================================*/
void BoxDrawInit(int w,int h)
{
	boxdraw.box_l = 2;
	boxdraw.brick_width  = 6;
	boxdraw.brick_height = 6;

	BoxDrawUpdate();
	boxdraw.box_x = (w-boxdraw.box_width)/2;
	boxdraw.box_y = (h-boxdraw.box_height)/2;
