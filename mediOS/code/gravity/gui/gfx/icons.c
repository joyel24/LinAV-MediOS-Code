...
struct icon_elem * loadIcon(char * filename)
{
    ...
    {
        printf("[loadIcon] bad ident (length)\n"); 
        goto err1;
    }
    ...
    for(i=0;i<5;i++)
    {
        ...
        {
            printf("[loadIcon] bad ident (string)\n"); 
            goto err1;
        }
    }
    ...
    {
        printf("[loadIcon] end of file reached - reading name\n"); 
        goto err2;
    }
    ...
    {
        printf("[loadIcon] end of file reached - reading icon data\n"); 
        goto err4;
    }*/
