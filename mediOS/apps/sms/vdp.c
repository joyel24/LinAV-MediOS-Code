...
__IRAM_CODE void vdp_ctrl_w(int data)
{
...
__IRAM_CODE int vdp_ctrl_r(void)
{
...
__IRAM_CODE void vdp_data_w(int data)
{
    int index;
...
__IRAM_CODE int vdp_data_r(void)
{
    uint8 temp = 0;
    vdp.pending = 0;
    temp = vdp.buffer;
...
__IRAM_CODE uint8 vdp_vcounter_r(void)
{
