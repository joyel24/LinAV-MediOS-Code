...
#define INPUT_LEFT        (0x00000002)
#define INPUT_RIGHT       (0x00000004)
#define INPUT_BUTTON2     (0x00000040)
#define INPUT_BUTTON1     (0x00000010)

/* These can be used for 'input.system' */
#define INPUT_START       (0x00000100)    /* Game Gear only */    
#define INPUT_PAUSE       (0x00000100)    /* Master System only */
#define INPUT_SOFT_RESET  (0x00000200)    /* Master System only */
#define INPUT_HARD_RESET  (0x00000020)    /* Works for either console type */
