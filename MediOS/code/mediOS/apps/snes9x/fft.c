...
/*__IRAM_DATA*/ static short pcm_F[2][FFT_SIZE];     /* PCM final       */
/*__IRAM_DATA*/ static short fft_F[2][FFT_SIZE/2+1]; /* FFT final       */
__IRAM_DATA static short fft_R[FFT_SIZE];        /* FFT real        */
__IRAM_DATA static short fft_I[FFT_SIZE];        /* FFT imaginary   */
__IRAM_DATA static int cur_fft_buf;
__IRAM_DATA static int pcm_start, pcm_end;
...
void fft_queue(void)
{
  const int pcm_frq = 32000; // VP FIXME
  int j;//, scale;
