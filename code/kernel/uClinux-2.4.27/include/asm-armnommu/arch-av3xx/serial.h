 ...
 *   02-28-2001 GJM     Modified for av3xx
 */
...
/* setup */
#define BASE_BAUD      (CONFIG_ARM_CLK / 16)
...
#endif	
	struct av3xx_async_struct *next_port;
	struct av3xx_async_struct *prev_port;
