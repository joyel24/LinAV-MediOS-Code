/*
*   include/target/arch_AV3XX/buttons.h
*
*   AvLo - linav project
...
#define BTMASK_LEFT          0x0002
#define BTMASK_RIGHT         0x0004
#define BTMASK_DOWN          0x0008
#define BTMASK_MENU3         0x0010
#define BTMASK_MENU1         0x0020
#define BTMASK_MENU2         0x0040
#define BTMASK_JOYPRESS      0x0080
#define BTMASK_ON            0x0100
#define BTMASK_OFF           0x0200

#define BTMASK_OK            0x0000
