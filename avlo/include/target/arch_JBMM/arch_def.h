...
#define usbIsConnected()                 0 //((inw(USB_STATE) & 0x40)!=0)
#define FWIsConnected()                  0 //((cpld_read(CPLD3) & 0x8)==0)
...
#define POWER_STATE                       0//0x30a24
#define POWER_CONNECTED                   0//((inw(POWER_STATE) >> 0x5)&0x1)
