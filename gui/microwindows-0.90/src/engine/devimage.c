...
printf("in LoadJPEG\n");
	...
	printf("file is a jpg\n");
	
	/* Step 1: allocate and initialize JPEG decompression object */
	/* We set up the normal JPEG error routines. */
	cinfo.err = jpeg_std_error(&jerr);
printf("before jpeg_create_decompress\n");
...
printf("before jpeg_read_header\n");
...
printf("before jpeg_calc_output_dimensions\n");
...
printf("before malloc 1 of size:%d\n",pimage->pitch * pimage->height);
	...
	if(pimage->bpp <= 8) {
	printf("before malloc 2 of size:%d\n",256*sizeof(MWPALENTRY));
...
printf("before start decompress\n");
...
printf("step 6\n");
	...
	ret = 1;
printf("end of step 6\n");
err:
printf("before finish decompress\n");
	/* Step 7: Finish decompression */
	//jpeg_finish_decompress (&cinfo);
printf("before destroy decompress\n");
	 ...
	 */
printf("returning from LoadJPG: %d\n",ret);
